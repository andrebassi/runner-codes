...
<CardGroup cols={2}>
  <Card title="Linux Machine" icon="linux">
    With KVM support (bare metal or nested virtualization)
  </Card>
  <Card title="Root Access" icon="lock">
    Required for Firecracker and Docker installation
  </Card>
</CardGroup>
...
<Accordion title="What setup installs">
...
# Skip Firecracker download
sudo infra.operator setup --skip-firecracker

# Skip kernel download
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    href="/cli/rootfs"
  >
    Create rootfs from Docker or base OS
  </Card>
  <Card
