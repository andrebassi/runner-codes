...
<CardGroup cols={2}>
  <Card title="8.4x Faster" icon="bolt">
    ~300ms vs ~2600ms boot time
  </Card>
  <Card title="Complete State" icon="camera">
    Memory, CPU, and device state
  </Card>
  <Card title="45 Languages" icon="code">
    All supported languages have snapshots
  </Card>
  <Card title="S3 Storage" icon="cloud">
    ~22.5 GB total for all snapshots
  </Card>
</CardGroup>
...
<Frame>
  <img src="/images/snapshot-full-architecture.svg" alt="Snapshot Full Architecture" />
</Frame>

## Cold Boot vs Warm Boot

<Frame>
  <img src="/images/snapshot-boot-comparison.svg" alt="Boot Comparison" />
</Frame>
...
# ... (machine-config, boot-source, drives, vsock) ...
...
# Wait for infra.operator guest to be ready
sleep 5
```
