...
<Card title="GnuCOBOL" icon="building-columns">
  GnuCOBOL compiler - COBOL for business and financial applications.
</Card>
...
<AccordionGroup>
  <Accordion title="Follow column structure">
    COBOL uses fixed columns: 1-6 sequence, 7 indicator, 8-72 code.
  </Accordion>

  <Accordion title="Use meaningful data names">
