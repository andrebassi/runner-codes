...
<Card title="MySQL" icon="database">
  MariaDB 10.11.14 - Full MySQL-compatible database for SQL operations.
</Card>
...
<AccordionGroup>
  <Accordion title="Create tables before inserting data">
  ...
  <Accordion title="Use proper MySQL syntax">
