...
<Card title="Crystal 1.18.2" icon="code">
...
<AccordionGroup>
  <Accordion title="Use high timeout">
  ...
  <Accordion title="Pre-compile when possible">
...
# 4. Download Crystal 1.18.2 from GitHub releases
cd /tmp
...
# 8. Unmount and Create Snapshot (with high resources)
sudo sync
...
# 10. Test Execution (with high timeout)
...
<AccordionGroup>
  ...
  <Accordion title="Keep code simple">
    More code means more types to infer and more LLVM work.
  </Accordion>

  <Accordion title="Use Ruby for quick tests">
