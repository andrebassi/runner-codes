...
<Card title="Bash 5.2" icon="terminal">
  Full GNU Bash with BusyBox utilities (grep, sed, awk, etc).
</Card>
...
# Then install bash: sudo chroot /mnt/bash apk add --no-cache bash
...
# {
#   "status": "success",
#   "stdout": "GNU bash, version 5.2.26(1)-release (x86_64-alpine-linux-musl)\n",
#   "executionTime": "~5ms"
# }
```
...
<Frame>
  <img src="/images/language-execution-flow.svg" alt="Bash Execution Flow" />
</Frame>
