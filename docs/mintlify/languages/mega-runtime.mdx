...
<Card title="All-in-One Runtime" icon="layer-group">
  Single 8GB rootfs with 47 languages. Ideal for development and environments where simplicity is preferred over minimal image size.
</Card>
...
<CardGroup cols={2}>
  <Card title="Simplified Management" icon="folder">
    Single image to maintain instead of 40+ separate rootfs files
  </Card>
  <Card title="Fast Development" icon="rocket">
    No need to switch images when testing different languages
  </Card>
  <Card title="Reduced Storage" icon="database">
    One 8GB image vs 40+ images totaling 80GB+
  </Card>
  <Card title="Easy Updates" icon="arrows-rotate">
    Update once, all languages updated
  </Card>
</CardGroup>
