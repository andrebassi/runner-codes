...
sudo -E infra.operator rootfs upload --lang mariadb-parser --bucket runner-codes
sudo -E infra.operator snapshot upload --lang mariadb-parser --bucket runner-codes
```
