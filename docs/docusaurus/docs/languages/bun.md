...
### Hello World
```javascript title="Simple console output"
console.log("Hello World");
```

### TypeScript Nativo
```typescript title="TypeScript with type annotations"
...
### Classes
```javascript title="Class with static properties"
class Calculator {
  add(a, b) { return a + b; }
...
### Async/Await
```javascript title="Async/await with delay"
