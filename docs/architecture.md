# Runner Codes: Technical Architecture
...
Runner Codes is a secure code execution environment designed to run untrusted code generated by Large Language Models (LLMs) in isolated Firecracker microVMs. The system provides hardware-level isolation through KVM virtualization while maintaining low latency through vsock communication.
