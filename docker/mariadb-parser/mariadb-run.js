#!/usr/bin/env node
/**
 * mariadb-run.js - MariaDB SQL Syntax Validator using node-sql-parser
 *
 * This script validates and formats MariaDB SQL queries WITHOUT requiring
 ...
 *
 * Usage: mariadb-run.js <file.sql>
 */

const fs = require('fs');
const { Parser } = require('node-sql-parser');

// Initialize parser with MariaDB dialect (MySQL compatible)
