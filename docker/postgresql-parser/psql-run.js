#!/usr/bin/env node
/**
 * psql-run.js - PostgreSQL SQL Syntax Validator using node-sql-parser
 *
 * This script validates and formats PostgreSQL SQL queries WITHOUT requiring
