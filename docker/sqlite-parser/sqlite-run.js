#!/usr/bin/env node
/**
 * sqlite-run.js - SQLite SQL Syntax Validator using node-sql-parser
 *
 * This script validates and formats SQLite SQL queries WITHOUT requiring
 ...
 *
 * Usage: sqlite-run.js <file.sql>
 */

const fs = require('fs');
const { Parser } = require('node-sql-parser');

// Initialize parser with SQLite dialect
